...
def build_image_prompt_hint(topic: str) -> str:
    ...
    return (
        ...
        "фотореалистичная сцена, женщина или мужчина в процессе создания чего-то полезного и красивого, "
        f"сюжет визуально связан с темой «{concise_topic}», живые эмоции, естественный свет, "
        "реальная студия или рабочее пространство, аккуратные детали в кадре, без текста, букв, логотипов и водяных знаков"
    )
                ...
                messages=[
                    {
                        ...
                        "content": (
                            ...
                            "Запрещай текст, буквы, логотипы, водяные знаки, постеры и надписи в кадре."
                        ),
                    },
                    {
                        "role": "user",
